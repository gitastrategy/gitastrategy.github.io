...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Gita Strategy — Bhagavad Gita for Modern Strategic Management" },
      {
        name: "description",
        content:
          "Bhagavad Gita verses mapped to strategic management: leadership, decision-making, ethics and execution.",
      },
